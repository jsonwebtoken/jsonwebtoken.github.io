...
const edPublicKey = `-----BEGIN PUBLIC KEY-----
MCowBQYDK2VwAyEAwmK6SSAu2E9V7uynkCKEaj5nZJyTvNG4x0KohsRzLpg=
-----END PUBLIC KEY-----`;

const edPrivateKey = `-----BEGIN PRIVATE KEY-----
...
interface DefaultTokenModel {
  token: string;
}

export interface DefaultUnsecuredTokenModel {
  token: string;
}

export interface DefaultTokenWithSecretModel extends DefaultTokenModel {
  secret: string;
  secretEncoding: EncodingValues;
}

export interface DefaultTokenWithKeysModel extends DefaultTokenModel {
  privateKey: string;
  privateKeyFormat: AsymmetricKeyFormatValues;
  jwk: object;
  publicKey: string;
  publicKeyFormat: AsymmetricKeyFormatValues;
}

export interface DefaultTokensModel {
  [index: string]:
...
export const DefaultTokensValues: DefaultTokensModel = {
  none: {
    token:
